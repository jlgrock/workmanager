...
@Profile(Constants.NOT_SPRING_PROFILE_FAST)
class MetricsConfiguration extends MetricsConfigurerAdapter implements EnvironmentAware {

    static final String ENV_METRICS = "metrics."
    static final String ENV_METRICS_GRAPHITE = "metrics.graphite."
    static final String ENV_METRICS_SPARK = "metrics.spark."
    static final String PROP_JMX_ENABLED = "jmx.enabled"
    static final String PROP_GRAPHITE_ENABLED = "enabled"
    static final String PROP_SPARK_ENABLED = "enabled"
    static final String PROP_GRAPHITE_PREFIX = ""

    static final String PROP_PORT = "port"
    static final String PROP_HOST = "host"
    static final String PROP_METRIC_REG_JVM_MEMORY = "jvm.memory"
    static final String PROP_METRIC_REG_JVM_GARBAGE = "jvm.garbage"
    static final String PROP_METRIC_REG_JVM_THREADS = "jvm.threads"
    static final String PROP_METRIC_REG_JVM_FILES = "jvm.files"
    static final String PROP_METRIC_REG_JVM_BUFFERS = "jvm.buffers"

    final Logger log = LoggerFactory.getLogger(MetricsConfiguration.class)
    ...
    static class GraphiteRegistry implements EnvironmentAware {
        ...
        final Logger log = LoggerFactory.getLogger(GraphiteRegistry.class)
    ...
    @Profile("ProfileConstants.NOT_SPRING_PROFILE_FAST")
    static class SparkRegistry implements EnvironmentAware {

        final Logger log = LoggerFactory.getLogger(SparkRegistry.class)
