...
import com.github.jlgrock.informatix.workmanager.web.filter.CachingHttpHeadersFilter
import com.github.jlgrock.informatix.workmanager.web.filter.StaticResourcesProductionFilter
import com.github.jlgrock.informatix.workmanager.web.filter.gzip.GZipServletFilter
...
class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    final Logger log = LoggerFactory.getLogger(WebConfigurer.class);
