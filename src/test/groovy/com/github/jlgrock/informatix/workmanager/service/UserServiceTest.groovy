...
import com.github.jlgrock.informatix.workmanager.Application
...
import com.github.jlgrock.informatix.workmanager.service.util.RandomUtil
...
public class UserServiceTest {
    ...
    public void assertThatOnlyActivatedUserCanRequestPasswordReset() {
        ...
        Optional<User> maybeUser = userService.requestPasswordReset("john.doe@localhost");
        assertThat(maybeUser.present).isFalse();
